...
ALTER SEQUENCE users_id_seq RESTART WITH 1; --Recomeça a contagem dos ids do 1
...
--SOFT DELETE
--1. Criar uma coluna na tabela de produto chamada 'deleted_at'
ALTER TABLE products ADD COLUMN "deleted_at" timestamp;
--2. Criar uma regar que vai rodar todas as vezes que solicitarmos o DELETE
